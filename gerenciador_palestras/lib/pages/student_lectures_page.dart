...
Future<bool> isPalestraRegistered(String estudanteId, String palestraId) async {
  ...
  final palestrasInscritas = (data['palestrasInscritas'] as List<dynamic>?)
          ?.map((e) => e.toString())
          .toList() ??
      [];

  return palestrasInscritas.contains(palestraId);
}
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return FutureBuilder<bool>(
                      future: isPalestraRegistered(widget.estudante.id, palestra.id!), 
                      builder: (context, snapshot) {
                          ...
                          child: ListTile(
                            ...
                            trailing: ElevatedButton(
                              ...
                              style: ElevatedButton.styleFrom(
                                backgroundColor: isRegistered ? Color.fromARGB(255, 248, 130, 130) :Color.fromARGB(255, 163, 130, 248),
                                shape: RoundedRectangleBorder(
